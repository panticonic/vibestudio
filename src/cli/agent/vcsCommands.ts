...
export const vcsCommands: CliCommand[] = [
  ...
  ...(
    [
      ...
      ["walk", "Run one curated provenance traversal (cause, cohort, rejections)"],
      ["query", "Run one read-only SELECT over the prov_* views"],
      ["search", "Find semantic subjects by their recorded prose"],
