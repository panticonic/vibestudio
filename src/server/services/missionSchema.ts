...
/**
 * Missions are pre-release and intentionally use one clean schema. An older
 * database is rejected by the canonical SQLite loader instead of being
 * interpreted under authority semantics it was never approved against.
 */
