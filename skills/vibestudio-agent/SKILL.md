...
| `vibestudio approval`    | `list`, `watch`, `resolve`, `submit`                                                          | Inspect and resolve the host's typed approval queue; `watch` also advertises a live CLI approval surface                                      |
...
| `vibestudio system-test` | `doctor`, `list`, `run`, `status`, `wait`, `runs`, `inspect`, `trajectory`, `rerun`, `cancel` | Run and diagnose durable headless agentic tests                                                                                               |
