...
NatStack builds several artifacts that look similar in source but run in different module systems. Build-system changes should preserve these contracts.
