...
| `heartbeat_registry`         | exact target and wake state plus channel/participant/action/error presentation                                                                                | mixed                                        | Host wake dispatch and product heartbeat UX share the row                                             | Split exact dispatch/fencing facts from durable product status before either owner changes.                                                                      |
