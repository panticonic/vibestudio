...
Imported browser history, Vibestudio browser-panel history, and address-bar
...
- Vibestudio browser panels record their own HTTP(S) main-frame navigations into
...
Vibestudio-local panel history therefore affect autocomplete the same way.

## Recording Vibestudio Browser History
...
available. If a source only exposes aggregate data for a URL, Vibestudio stores the
...
For a full migration into Vibestudio:
...
4. Use the address bar normally. Imported history, Vibestudio-local history,
