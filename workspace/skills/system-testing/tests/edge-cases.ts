...
export const edgeCaseTests: TestCase[] = [
  {
    ...
    category: "edge-cases",
    prompt: "Exercise recovery from invalid eval arguments. Finish with EDGE_EVAL_ARGS_OK and retry-succeeded.",
  ...
  },
  {
    ...
    category: "edge-cases",
    prompt: "Exercise recovery from an invalid import. Finish with EDGE_IMPORT_ERROR_OK and final-visible.",
  ...
  },
  {
    ...
    category: "edge-cases",
    prompt: "Exercise recovery from a missing file read. Finish with EDGE_FS_NOT_FOUND_OK and final-visible.",
