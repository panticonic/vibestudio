...
| `git` | namespace | `http`, `upstreamStatus`, `pushUpstream`, `pullUpstream`, `publishRepo`, `configureUpstream`, `importProject`, `completeWorkspaceDependencies`, `setSharedRemote`, `removeSharedRemote` |  |
