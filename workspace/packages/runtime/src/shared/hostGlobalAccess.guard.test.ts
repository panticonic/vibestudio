...
// bare `__vibestudioRequire__` mention, so prose comments and error-message
...
describe("host-global access guard", () => {
  it("workspace packages resolve host modules via imports, not globalThis.__vibestudioRequire__", () => {
