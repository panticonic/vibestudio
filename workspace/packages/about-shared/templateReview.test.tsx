  ...
  it("records an ordinary VCS integration decision instead of discarding the comparison", async () => {
    const compare = vi
      ...
      .mockResolvedValueOnce({
        ...
        counts: { shared: 0, alreadySatisfied: 0, actionable: 1, conflicting: 0, blocked: 0, accounted: 0, historical: 0 },
        changes: [{
      ...
      .mockResolvedValueOnce({
        ...
        counts: { shared: 0, alreadySatisfied: 0, actionable: 0, conflicting: 0, blocked: 0, accounted: 1, historical: 0 },
        changes: [],
        nextCursor: null,
      });
    ...
    render(
      <Theme>
        <TemplateReviewPanel review={{ contextId: "ctx:templates", items: [item] }} compare={compare} integrate={integrate} onCompleted={onCompleted} />
      </Theme>
    );
