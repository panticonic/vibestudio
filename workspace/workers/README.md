...
services, and HTTP routes — live in `meta/vibestudio.yml`.

DO-backed service (in `meta/vibestudio.yml`):
...
Vibestudio base prompt, `meta/AGENTS.md`, the generated skill index,
...
export class CodeReviewWorker extends AgentWorkerBase {
  ...
  // The system prompt is composed from Vibestudio base + meta/AGENTS.md.
