...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `source-only`   | Public entries point at `src/*.ts`; there is no `build` script or package-local build artifact. TypeScript-aware host bundlers consume the source directly.                                     | `durable`, `identity`, `mobile-iroh`, `service-schemas`, `shared`, `shell-core`, `sqlite`, `unit-host`, `workspace-contracts`, `workspace` |
