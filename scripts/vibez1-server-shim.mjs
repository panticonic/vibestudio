#!/usr/bin/env node
// `vibez1-server` bin for the npm-published packages. Pins VIBEZ1_APP_ROOT
...
// server otherwise defaults VIBEZ1_APP_ROOT to process.cwd() — see
...
if (!env["VIBEZ1_APP_ROOT"]) env["VIBEZ1_APP_ROOT"] = packageRoot;
