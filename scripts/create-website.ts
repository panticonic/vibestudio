...
if (!destination)
  throw new Error("Usage: pnpm create:website --out-dir PATH [--sdk-dir PATH] [--name NAME]");
...
if (fs.existsSync(target))
  throw new Error("Choose a new output directory; an existing project is never overwritten");
