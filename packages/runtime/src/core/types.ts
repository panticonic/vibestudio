...
import type { CdpPage } from "@vibestudio/cdp-client";
 ...
 * @example
 * ```ts
 * import { z, type EventSchemaMap } from "@vibestudio/runtime";
 *
 ...
 * @example
 * ```ts
 * import { z, type InferEventMap } from "@vibestudio/runtime";
 *
 * const schemas = {
...
export interface CdpAutomation {
  /** The canonical @vibestudio/cdp-client automation page for this panel target. */
