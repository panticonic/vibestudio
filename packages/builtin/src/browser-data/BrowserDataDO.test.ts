...
describe("BrowserDataDO schema", () => {
  ...
  it("enforces tier, sensitivity, and principals from the typed method table", () => {
    ...
    const resolve = (
      method: keyof typeof browserDataMethods
    ): import("@vibestudio/rpc").ResolvedRpcAuthority | null =>
      (
        instance as unknown as {
          rpcAuthorityDeclaration(
            name: string,
            schema: (typeof browserDataMethods)[keyof typeof browserDataMethods]
          ): import("@vibestudio/rpc").ResolvedRpcAuthority | null;
        }
      ).rpcAuthorityDeclaration(method, browserDataMethods[method]);
