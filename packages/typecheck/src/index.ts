/**
 * @vibestudio/typecheck — TypeScript type checking for Vibestudio projects.
 *
 ...
 * @example
 * ```typescript
 * import { TypeCheckService, createDiskFileSource, loadSourceFiles } from "@vibestudio/typecheck";
 *
