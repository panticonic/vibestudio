...
export const CAPABILITY_DOMAINS = {
  ...
  "mobile.provision": { domain: "people", verb: "manage" },
  ...
  "development.native.execute": { domain: "automation", verb: "act" },
  "development.runs.force-retire": { domain: "computer", verb: "manage" },
  "development.sessions.cleanup.retry": { domain: "files", verb: "act" },
  "development.sessions.destroy": { domain: "files", verb: "act" },
  "development.sessions.force-retire": { domain: "files", verb: "manage" },
